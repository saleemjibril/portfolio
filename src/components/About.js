    ...
    return (
        <div className="about">
            ...
            <div className="about__body">
                ...
                2 years overall Software Developer experience. 3 months of React. Skilled in solving problems with HTML, CSS, JavaScript, React. Targeting Fullstack roles. Currently working on an activity monitoring app using React and NodeJS.
